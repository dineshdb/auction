...
//        userList.add(userRepository.save(new User("hkeemar0@tinyurl.com", passwordEncoder.encode("password"), "nkeemar0", "4711065522", "Keemar")));
//        userList.add(userRepository.save(new User("wwagen1@furl.net", passwordEncoder.encode("password"), "swagen1", "2721167273", "Wagen")));
//        userList.add(userRepository.save(new User("mmcwhan2@dyndns.org", passwordEncoder.encode("password"), "cmcwhan2", "7775342958", "McWhan")));
//        userList.add(userRepository.save(new User("gminard3@last.fm", passwordEncoder.encode("password"), "sminard3", "6841452381", "Minard")));
//        userList.add(userRepository.save(new User("dhollow4@nytimes.com", passwordEncoder.encode("password"), "nhollow4", "7143045279", "Hollow")));
//        userList.add(userRepository.save(new User("smungan5@taobao.com", passwordEncoder.encode("password"), "bmungan5", "8324159096", "Mungan")));
//        userList.add(userRepository.save(new User("ldeeman6@army.mil", passwordEncoder.encode("password"), "wdeeman6", "5524908551", "Deeman")));
//        userList.add(userRepository.save(new User("cheningam7@psu.edu", passwordEncoder.encode("password"), "bheningam7", "8724024848", "Heningam")));
//        userList.add(userRepository.save(new User("cstrangward8@flavors.me", passwordEncoder.encode("password"), "lstrangward8", "3291525092", "Strangward")));
//        userList.add(userRepository.save(new User("fgrisdale9@cmu.edu", passwordEncoder.encode("password"), "mgrisdale9", "3664714558", "Strangward")));
//        userList.add(userRepository.save(new User("byurenina@zdnet.com", passwordEncoder.encode("password"), "tyurenina", "6263903601", "Yurenin")));
//        userList.add(userRepository.save(new User("cwaitlandb@drupal.org", passwordEncoder.encode("password"), "rwaitlandb", "2121562452", "Waitland")));
//        userList.add(userRepository.save(new User("gbrastedc@wired.com", passwordEncoder.encode("password"), "tbrastedc", "2119552264", "Brasted")));
//        userList.add(userRepository.save(new User("rackwoodd@salon.com", passwordEncoder.encode("password"), "backwoodd", "9447277255", "Ackwood")));
//        userList.add(userRepository.save(new User("bguwere@jimdo.com", passwordEncoder.encode("password"), "aguwere", "7512439388", "Guwer")));
//        userList.add(userRepository.save(new User("dpepperellf@rediff.com", passwordEncoder.encode("password"), "epepperellf", "4438770804", "Pepperell")));
//        userList.add(userRepository.save(new User("ktophamg@gnu.org", passwordEncoder.encode("password"), "atophamg", "4133078522", "Topham")));
//        userList.add(userRepository.save(new User("ikinsleyh@macromedia.com", passwordEncoder.encode("password"), "kkinsleyh", "2437879462", "Kinsley")));
//        userList.add(userRepository.save(new User("acouragei@cargocollective.com", passwordEncoder.encode("password"), "acouragei", "5819207964", "Courage")));
//        userList.add(userRepository.save(new User("draeburnj@icq.com", passwordEncoder.encode("password"), "draeburnj", "1722032519", "Raeburn")));
//        userList.add(userRepository.save(new User("rheggk@ustream.tv", passwordEncoder.encode("password"), "sheggk", "6131985214", "Hegg")));
//        userList.add(userRepository.save(new User("rskittreall@quantcast.com", passwordEncoder.encode("password"), "sskittreall", "7094859986", "Skittreal")));
//        userList.add(userRepository.save(new User("fleylandm@cmu.edu", passwordEncoder.encode("password"), "aleylandm", "5274051353", "Leyland")));
//        userList.add(userRepository.save(new User("lskatchern@pcworld.com", passwordEncoder.encode("password"), "askatchern", "5683393296", "Skatcher")));
//        userList.add(userRepository.save(new User("glockep@webnode.com", passwordEncoder.encode("password"), "elockep", "1187773736", "Locke")));
//        userList.add(userRepository.save(new User("mmorrallo@reddit.com", passwordEncoder.encode("password"), "fmorrallo", "9839717424", "Morrall")));
//        userList.add(userRepository.save(new User("dtennockq@indiegogo.com", passwordEncoder.encode("password"), "ttennockq", "1748716681", "Tennock")));
//        userList.add(userRepository.save(new User("atosh502@gmail.com", passwordEncoder.encode("password"), "atosh502", "9843599926", "Ktm")));
//        userList.add(userRepository.save(new User("admin@ioe.com", passwordEncoder.encode("password"), "admin123", "6299953489", "Pulchowk")));
//        userList.add(userRepository.save(new User("foo@bar.com", passwordEncoder.encode("password"), "foobar", "1234567891", "Lalitpur")));
//        userList.add(userRepository.save(new User("snow@den.com", passwordEncoder.encode("password"), "snowden", "2345619209", "Russia")));
//        User seller = userRepository.save(new User("seller@gmail.com", passwordEncoder.encode("password"), "seller", "123765490", "Pokhara"));
//
